                ...
                <div className="container px-6 py-12 h-full">
                    <div className="flex justify-center items-center flex-wrap h-full g-6 text-gray-800">
                        <div className="md:w-8/12 lg:w-6/12 mb-12 md:mb-0">
                            <img src="https://png.pngtree.com/png-clipart/20240502/original/pngtree-flat-design-concepts-online-learning-with-online-teacher-in-computer-png-image_14991353.png" className="w-full" alt="Phone" />
                        </div>
